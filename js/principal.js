...
${personal5.nombre} tiene un aumento de ${personal5.montoAdicional()} <br>
<br> El total de monto adicional que debe pagar la empresa es de ${empresa .totalMontoAdicional()}  `